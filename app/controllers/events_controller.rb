class EventsController < ApplicationController
  ...
  before_action :require_host_or_admin, only: %i[ new create edit update destroy ]
  ...
  def create
    ...
    @event.user = current_user  # Assign host
  ...
  private
    ...
    def event_params
      params.expect(event: [ :title, :description, :date, :location, :capacity, :rsvp_closes_before, :banner_image ])
    end

    # Authorization: Only hosts and admins can manage events
